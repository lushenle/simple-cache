FROM registry.shenle.lu/library/node:22-alpine AS frontend-builder
...
FROM registry.shenle.lu/library/golang:1.26-alpine AS go-builder
...
FROM registry.shenle.lu/library/alpine:3.21
